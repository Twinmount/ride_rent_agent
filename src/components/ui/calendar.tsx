    ...
    <DayPicker
      ...
      components={{
        ...
        Nav: ({ className, children, ...props }) => {
          ...
          return (
            <nav className={cn("flex items-center", className)} {...props}>
              <Button
                variant="outline"
                className="absolute left-0 p-0 w-7 h-7 bg-transparent opacity-80 hover:opacity-100"
                type="button"
              ...
              <Button
                variant="outline"
                className="absolute right-0 p-0 w-7 h-7 bg-transparent opacity-80 hover:opacity-100"
                type="button"
        ...
        CaptionLabel: ({ children }) => (
          <Button
            className="w-full h-7 text-sm font-medium truncate"
            variant="ghost"
            size="sm"
            onClick={() =>
