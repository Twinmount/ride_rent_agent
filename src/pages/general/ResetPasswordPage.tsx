  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full flex items-center justify-center z-10 px-4">
        <div className="w-full max-w-md backdrop-blur-2xl bg-gradient-to-br from-white/15 to-white/10 border border-white/25 rounded-3xl shadow-2xl p-7 hover:border-white/35 transition-all duration-300">
